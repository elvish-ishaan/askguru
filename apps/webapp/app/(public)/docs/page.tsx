...
export default function DocsPage() {
  ...
  const codeBlocks = [
    "npm install @askguru/sdk",
    "yarn add @askguru/sdk",
  ...
  config={{
    ...
    apiEndpoint: 'https://www.@askguru/sdk.ai/api/chat'
  }}
/>`,
  ];
            ...
            <div className="space-y-4">
              <div className="relative group">
                <pre className="bg-slate-900 dark:bg-slate-950 text-slate-100 p-5 rounded-xl border border-slate-800 shadow-lg overflow-x-auto">
                  <code className="text-sm font-mono">npm install @askguru/sdk</code>
                </pre>
                <button
              ...
              <div className="relative group">
                <pre className="bg-slate-900 dark:bg-slate-950 text-slate-100 p-5 rounded-xl border border-slate-800 shadow-lg overflow-x-auto">
                  <code className="text-sm font-mono">yarn add @askguru/sdk</code>
                </pre>
                <button
