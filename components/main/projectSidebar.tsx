...
import { LayoutDashboard, KeyRound, BarChart3, Plug } from "lucide-react";
...
export default function ProjectSidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen  border-r bg-[var(--sidebar)] text-[var(--sidebar-foreground)] flex flex-col">
      {/* Sidebar Header */}
